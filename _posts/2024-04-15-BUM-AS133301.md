...
description: "My ISP had no VLAN isolation. I was seeing strangers' PPPoE sessions and IPv6 traffic on my WAN during an IPL match. Here's how I caught AS133301 and why they ignored me."
...
image:
  ...
  lqip: data:image/webp;base64,UklGRoYAAABXRUJQVlA4IHoAAADwAwCdASoUAAwAPm0skkWkIqGYBABABsSzAE6ZQAGoLmv4Aiwka1SwAP78aqHIEW8tYPfjWg5c2i4xVqa/5zKyTEUl1Bf27EhiPvp5HxVUx+3K5fSLwMx9/4Ib5mlsn9tJHy+UfK9s6tv9JGpVHPjW76N2XvlnvAAAAA==
---
...
<img src="/assets/img/posts/BUM-AS133301/Rx.webp" alt="MikroTik interface statistics showing abnormally high Rx broadcast traffic rates indicating VLAN isolation failure" loading="lazy"><em>Rx Stats</em>
...
<img src="/assets/img/posts/BUM-AS133301/torch.webp" alt="MikroTik Torch tool capturing unexpected broadcast frames from other customers WAN interface" loading="lazy"><em>Running torch on WAN</em>
